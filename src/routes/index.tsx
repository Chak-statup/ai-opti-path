        ...
        <section className="lp-about">
          <details className="lp-about-details">
            ...
            <p className="lp-about-body">
              ...
              strategy you control: quality tier, scaling, in-house build, vendor
              independence, platform reach; and the environment you don&rsquo;t (serving
            ...
            <p className="lp-about-body">
              ...
              the ARPU premium with the quality bar; and burns more tokens; a premium tier
